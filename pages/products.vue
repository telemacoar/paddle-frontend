...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "Precio Venta", value: "price_sell" },
      { text: "Iva", value: "iva" },
      { text: "Foto", value: "picture" },
      { text: "Estoqueable", value: "stockeable" },
  ...
  methods: {
    ...
    async deleteItemConfirm() {
      await this.$axios.$delete("/api/products/" + this.editedItem.id);
    ...
    async save() {
      if (this.editedIndex > -1) {
        await this.$axios.$put(
          "/api/products/" + this.editedItem.id,
          this.editedItem
        );
